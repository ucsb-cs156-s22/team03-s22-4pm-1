            ...
            <Nav className="me-auto">
              ...
              }
              {
                hasRole(currentUser, "ROLE_USER") && (
                  <NavDropdown title="UCSB Dining Commons Menu Items" id="appnavbar-dining-commons-menu-items-dropdown" data-testid="appnavbar-dining-commons-menu-items-dropdown" >
                    <NavDropdown.Item as={Link} to="/menuItems/list" data-testid="appnavbar-dining-commons-menu-items-list">List Menu Items</NavDropdown.Item>

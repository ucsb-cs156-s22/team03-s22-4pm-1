...
describe("Reviews tests", () => {
  ...
  test("renders without crashing for empty table with user not logged in", () => {
    ...
    render(
      <QueryClientProvider client={queryClient}>
        <MemoryRouter>
          <ReviewsTable dates={[]} currentUser={currentUser} />
        </MemoryRouter>
      </QueryClientProvider>
  ...
  test("Has the expected colum headers and content for adminUser", () => {
    ...
    const { getByText, getByTestId } = render(
      <QueryClientProvider client={queryClient}>
        <MemoryRouter>
          <ReviewsTable dates={reviewsFixtures.threeReviews} currentUser={currentUser} />
        </MemoryRouter>
      </QueryClientProvider>
    ...
    const expectedHeaders = ["id", "Reviewer Email", "Stars", "Date Reviewed", "Comments"];

...
public class MenuItemReviewControllerTests extends ControllerTestCase {
        ...
        public void test_that_logged_in_user_can_get_by_id_when_the_id_exists() throws Exception {
                ...
                MenuItemReview menuItemReview = MenuItemReview.builder()
                                .reviewerEmail("andywu@ucsb.edu")
                                .stars(1)
                                .comments("terrible, will not come back. ever.")
                                .dateReviewed(ldt)
                                .build();
        ...
        public void logged_in_user_can_get_all_MenuItemReview() throws Exception {
                ...
                MenuItemReview menuItemReview2 = MenuItemReview.builder()
                                .reviewerEmail("mccheeseburger@ucsb.edu")
                                .stars(5)
                                .comments("Great!!!")
                                .dateReviewed(ldt2)
                                .build();
                ...
                expectedMenuItemReview.addAll(Arrays.asList(menuItemReview1, menuItemReview2));
        ...
        public void an_admin_user_can_post_a_new_menuItemReview() throws Exception {
                ...
                MenuItemReview menuItemReview1 = MenuItemReview.builder()
                                .reviewerEmail("andywu@ucsb.edu")
                                .stars(1)
                                .comments("terrible and will not come back")
                                .dateReviewed(ldt1)
                                .build();
                ...
                MvcResult response = mockMvc.perform(
                                post("/api/MenuItemReview/post?reviewerEmail=andywu@ucsb.edu&stars=1&comments=terrible and will not come back&dateReviewed=2022-01-03T00:00:00")
                                                .with(csrf()))
                                .andExpect(status().isOk()).andReturn();
